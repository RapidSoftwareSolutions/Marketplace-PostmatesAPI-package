...
$app->post('/api/PostmatesAPI/returnDelivery', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . 'v1/customers/'.$post_data['args']['customerId'].'/deliveries/'.$post_data['args']['deliveryId'].'/return';
